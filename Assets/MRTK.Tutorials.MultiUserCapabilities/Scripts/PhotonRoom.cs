...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    public class PhotonRoom : MonoBehaviourPunCallbacks, IInRoomCallbacks
    {
        ...
        public static GameObject sceneUnderstandingObject;
        public static GameObject MessageTransformerObject;
        ...
        private void Start()
        {
            ...
            if (PhotonNetwork.PrefabPool is DefaultPool pool)
            {
                ...
                if (sceneUnderstandingObject != null)
                {
                    pool.ResourceCache.Add(sceneUnderstandingObject.name, sceneUnderstandingObject);
                }
                if (MessageTransformerObject != null)
                {
                    pool.ResourceCache.Add(MessageTransformerObject.name, MessageTransformerObject);
                }
            }
        }
        ...
        private void CreatPlayer()
        {
            ...
            // var testObject = PhotonNetwork.Instantiate(roverExplorerPrefab.name, Vector3.zero, Quaternion.identity);
            // var testObject2 = PhotonNetwork.Instantiate(sceneUnderstandingObject.name, Vector3.zero, Quaternion.identity);
        }
